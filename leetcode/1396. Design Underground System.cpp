//https://leetcode.com/problems/design-underground-system/submissions/961124657/
...
public:
    ...
    void checkOut(int id, string stationName, int t) {
        ...
        if(tr==sum.end()) sum[stationName]={1,t-entry[id].second};
        else{
            tr->second[0]++;
    ...
    double getAverageTime(string startStation, string endStation) {
        ...
        if(tr!=sum.end()) return((double)tr->second[1])/(double)tr->second[0];
        else return 0;
